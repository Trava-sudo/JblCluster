...
public class JblGuestPassChangeEvent extends JpsOpUsrPayCompl implements JblVisitableEvent {
    ...
    private Integer overnightsDiff;
    ...
    public Integer getOvernightsDiff() {
        return overnightsDiff;
    }

    public void setOvernightsDiff(Integer overnightsDiff) {
        this.overnightsDiff = overnightsDiff;
    }

    public Integer getOvernights() { return overnights; }

    public void setOvernights(Integer overnights) { this.overnights = overnights; }
}
