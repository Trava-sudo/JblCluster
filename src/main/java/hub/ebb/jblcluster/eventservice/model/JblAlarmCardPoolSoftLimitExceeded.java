...
public class JblAlarmCardPoolSoftLimitExceeded extends JpsEvtAlarm implements JblVisitableEvent {

    private String cardPoolName;
    private int cardPoolActualValue;
    private int cardPoolSoftLimitValue;

    @Override
    public Long messageId() {
        return JmsMessageIDBundle.ALARM_JBL_CARD_POOL_SOFT_LIMIT_EXCEEDED;
    }
    ...
    public int getCardPoolActualValue() {
        return cardPoolActualValue;
    }

    public void setCardPoolActualValue(int cardPoolActualValue) {
        this.cardPoolActualValue = cardPoolActualValue;
    }

    public int getCardPoolSoftLimitValue() {
        return cardPoolSoftLimitValue;
    }

    public void setCardPoolSoftLimitValue(int cardPoolSoftLimitValue) {
        this.cardPoolSoftLimitValue = cardPoolSoftLimitValue;
    }
