...
public class JblAlarmTariffModuleException extends JpsEvtAlarm implements JblVisitableEvent {

    @Override
    public Long messageId() {
        return JmsMessageIDBundle.ALARM_JBL_TARIFF_MODULE_EXCEPTION;
    }
