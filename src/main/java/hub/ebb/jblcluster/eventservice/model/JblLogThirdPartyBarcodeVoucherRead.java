...
public class JblLogThirdPartyBarcodeVoucherRead extends JpsEvtLog implements JblVisitableEvent {


    private ApplyDiscountResult applyDiscountResult;
    private String thirdPartyVoucherBarcode;
    ...
    public String getThirdPartyVoucherBarcode() {
        return thirdPartyVoucherBarcode;
    }

    public void setThirdPartyVoucherBarcode(String thirdPartyVoucherBarcode) {
        this.thirdPartyVoucherBarcode = thirdPartyVoucherBarcode;
    }

    @Override
    public SpecCodeEnum getEventSpecCode() {
        return SpecCodeEnum.JblLogThirdPartyBarcodeVoucherRead;
    }
