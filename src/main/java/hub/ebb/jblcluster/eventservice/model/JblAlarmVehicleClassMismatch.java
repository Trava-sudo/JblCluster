...
public class JblAlarmVehicleClassMismatch extends JpsEvtAlarm implements JblVisitableEvent {

    private String vehicleClass, uid, vehicleClassDetected;

    @Override
    public Long messageId() {
        return SpecCodeEnum.JblAlarmVehicleClassMismatch.getMessageId();
    }
    ...
    public String getVehicleClassDetected() {
        return vehicleClassDetected;
    }

    public void setVehicleClassDetected(String vehicleClassDetected) {
        this.vehicleClassDetected = vehicleClassDetected;
    }
}
