...
public class JblAlarmFixedPathNotRespected extends JpsEvtAlarm implements JblVisitableEvent {

    @Override
    public Long messageId() {
        return JmsMessageIDBundle.ALARM_JBL_FIXED_PATH_NOT_RESPECTED;
    }
