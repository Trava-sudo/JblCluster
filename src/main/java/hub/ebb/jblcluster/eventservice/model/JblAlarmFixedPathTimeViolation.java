...
public class JblAlarmFixedPathTimeViolation extends JpsEvtAlarm implements JblVisitableEvent {

    private String cardNumber;

    @Override
    public Long messageId() {
        return JmsMessageIDBundle.ALARM_JBL_FIXED_PATH_TIME_VIOLATION;
    }
