...
public class JmsCancelSalePaymentOperation extends JpsOpUsrPayCompl implements JblVisitableEvent {

    @Override
    public String eventBusPublishUrl() {
        return JblAPIEventBusBundle.PUB_SUB_CANCEL_SALE_PAYMENT_TRANSIENT;
    }
