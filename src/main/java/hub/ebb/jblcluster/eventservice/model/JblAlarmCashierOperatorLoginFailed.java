...
public class JblAlarmCashierOperatorLoginFailed extends JpsEvtAlarm implements JblVisitableEvent {

    @Override
    public Long messageId() {
        return JmsMessageIDBundle.ALARM_JBL_CASHIER_LOGIN_FAILED;
    }
